...
function initPageSliders(){
    (function($){
        ...
        $(".fullwidth-slider").owlCarousel({
           ...
           // autoHeight: true,
            navigation: true,
            navigationText: ["<span class='fas fa-angle-left'></span>", "<i class='fas fa-angle-right'></span>"]
        });
        ...
        $(".fullwidth-slider-auto").owlCarousel({
           ...
           // autoHeight: true,
            ...
            navigation: true,
            navigationText: ["<span class='ifas fa-angle-left'></span>", "<i class='fas fa-angle-right'></span>"],
            //pagination : false,
